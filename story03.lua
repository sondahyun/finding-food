...
local function parse()
	local filename = system.pathForFile("Content/JSON/story03.json")
...
function scene:create( event )
	...
	local script = display.newText("더미 텍스트입니다.", section.x+50, section.y+30, display.contentWidth, 120)
    ...
    local home = audio.loadStream( "Content/PNG/script/계곡물 흐르는 소리.mp3" )
