...
local function parse()
	local filename = system.pathForFile("Content/JSON/story05.json")
...
local explosionSound = audio.loadSound( "Content/PNG/script/새싹.mp3" )
...
function scene:create( event )
	...
	local script = display.newText("더미 텍스트입니다.", section.x+220, section.y+30, display.contentWidth, 120)
